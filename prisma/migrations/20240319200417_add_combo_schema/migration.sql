...
-- AddForeignKey
ALTER TABLE "Heart" ADD CONSTRAINT "Heart_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Combo"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Input" ADD CONSTRAINT "Input_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Combo"("id") ON DELETE CASCADE ON UPDATE CASCADE;
